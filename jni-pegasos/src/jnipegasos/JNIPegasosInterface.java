...
public class JNIPegasosInterface {
	 ...
	 */
	private native void trainmodel(String trainfilename, String modelfilename, String testfilename, LearningParameter lp);
	
	public void trainModel(String trainfilename, String modelfilename, String testfilename, LearningParameter lp) {
		trainmodel(trainfilename, modelfilename, testfilename, lp);
	}
	/**
