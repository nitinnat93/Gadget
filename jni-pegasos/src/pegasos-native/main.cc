...
*/
  ...
  long converge_iter;
  double obj_value, obj_value_prev, norm_value,loss_value,zero_one_error,test_loss,test_error, epsilonVal;
  /*
  ...
  */
  LearnReturnLast(Dataset,Labels,dimension,testDataset,testLabels,
		   lambda,max_iter,exam_per_iter, replace, iter,
		   model_filename,
		   trainTime,calc_obj_time,obj_value, obj_value_prev, norm_value,
		   loss_value,zero_one_error,
		   test_loss,test_error, converge_iter,
       epsilonVal,
		   0,0.0,0,0.0);
  ...
  std::cout << readingTime << " = Time for reading\n"
      << trainTime << " = Time for training\n" 
